<%-- 
    Document   : Student_Approve
    Created on : 16 Nov, 2024, 5:47:22 PM
    Author     : trios
--%>
...
<a class="sk-brand" href="Admin_Home.jsp" style="display:flex; align-items:center; gap:8px;">
  ...
  <div class="hero-inner">
    <div class="row align-items-center g-5">
      ...
      <h2 class="header-title">Student Approval List</h2>
       <div class="container1">
     
    <div class="row justify-content-center">
        <%
            DbConnection db1 = new DbConnection();
            String query = "select * from student_register where Admin_Approve='NOT APPROVED'";
            ResultSet rs = db1.Select(query);
            while (rs.next()) {
                String U_Id=rs.getString("student_id");
        %>
         <div class="card1">
    <div class="card1-image">
        <img src="student_img.jsp?name=<%=rs.getInt("student_id")%>" class="card-img" style="width:100px;height: 100px;" alt="Profile Picture">
    </div>
      <div class="card1-content">
        <p class="card-text">
            <strong>Student Name:</strong> <%= rs.getString("student_name") %><br>
            <strong>Email ID:</strong> <%= rs.getString("student_mail") %><br>
    ...
    <a href="Request1.jsp?student_id=<%=rs.getString("student_id")%>" class="btn approved-btn">Approve</a> 
   
    <a href="Request2.jsp?student_id=<%=rs.getString("student_id")%>" class="btn rejected-btn">Reject</a>
</div>
