...
<%
    ...
    String sessionName   = (String) session.getAttribute("teacher_name");
    String sessionMail   = (String) session.getAttribute("teacher_mail");
    ...
    session.removeAttribute("teacher_mail");
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>SkillSync – Teacher Registration</title>
...
<div class="page-wrapper">
  <div class="reg-card">
    ...
    <!-- Form -->
    <div class="reg-body">
      <form action="Teacher_Register" method="post" enctype="multipart/form-data" 
          ...
          <div class="row g-3">
            <div class="col-12">
              <div class="field-group">
                <label for="teacher_name">Full Name <span class="field-required">*</span></label>
                ...
                <div class="err-msg" id="err-teacher_name">Please enter your full name.</div>
              </div>
            </div>
        ...
        <div class="reg-success-overlay" id="successOverlay">
          ...
          <div class="reg-success-actions">
            ...
            <a href="Teacher_Register.jsp" class="btn-prev text-decoration-none" style="display:inline-flex;border:1.5px solid var(--border);">
...
<script>
  ...
  window.addEventListener('DOMContentLoaded', function() {
    ...
    if (isSuccess) {
      ...
      /* Parse teacher ID from msg1 e.g. "Your User Identification Number Is :\n42" */
      var idMatch = msg1.match(/(\d+)\s*$/);
      var teacherId = idMatch ? idMatch[1] : '—';

      document.getElementById('successName').textContent  = name || 'Teacher';
      document.getElementById('successMail').textContent  = mail || '';
      document.getElementById('successId').textContent    = 'ID: ' + teacherId;

      /* Also show a toast */
      showToast('success',
        '🎉 Registration Successful!',
        'Welcome ' + (name || '') + '! Your Teacher ID is ' + teacherId + '.',
        8000);
  ...
  function validateStep(step) {
    var ok = true;
    if (step === 0) {
      ok = chkReq('teacher_name', /\S{2}/, 'Please enter your full name.') && ok;
