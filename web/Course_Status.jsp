<%-- 
    Document   : Course_Status
    Created on : 30-Sep-2025, 15:14:54
    Author     : user
--%>
...
<div class="student-course-container">
    ...
    <%
        ResultSet rs = db.Select(
            "SELECT s.student_id,c.course_id,s.student_name,c.course_name,sm.course_status,s.college_name,s.department,s.degree " +
    ...
    <table class="course-table">
        ...
        %>
            <tr>
                ...
                <td><%= rs.getString("course_status") %></td>
            </tr>
        <%
        }
        %>
