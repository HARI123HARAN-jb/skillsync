<%-- 
    ...
    Created on : 08-Oct-2025, 10:25:14
    Author     : user
--%>
...
<div class="teacher-course-container">
    <h1 class="page-title">Teacher Course Details</h1>

     <%
        
         DbConnection db = new DbConnection();
    String query = "SELECT c.course_id, c.course_name, t.teacher_id, t.teacher_name, t.college_name, t.department, t.degree " +
                   "FROM courses c " +
                   "JOIN teacher_register t ON t.teacher_id = c.teacher_id " +
                   "ORDER BY c.course_name, t.teacher_name";
