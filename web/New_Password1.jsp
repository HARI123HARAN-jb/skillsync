<%-- 
    Document   : New_Password1
    Created on : 11-Oct-2025, 16:29:11
    Author     : user
--%>
            ...
            <div class="col-lg-12">
                <div class="row"style="align-items: center;justify-content: center;">
                    <div class="card"style="width: 30rem;align-items: center;color: black;margin-top: 50px;margin-bottom: 50px;">
                        <h5 class="card-title"style="margin-top: 10px;">New Password</h5>
              <script>
function validateLogin() {
    ...
    <div class="formbold-main-wrapper">
        <form action="Update_Password1" method="post">
            <label>New Password</label>
            <input type="password" name="new_password" class="formbold-form-input" required>

            <label>Confirm Password</label>
            <input type="password" name="confirm_password" class="formbold-form-input" required>

            <input type="submit" value="UPDATE PASSWORD" class="formbold-btn">
        </form>
    </div>
                 </div>
             </div>
