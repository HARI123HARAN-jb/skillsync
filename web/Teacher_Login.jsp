<%-- 
    ...
    Created on : 10 Jun, 2025, 1:49:37 PM
    Author     : Admin1
--%>
						...
						<nav class="navbar navbar-expand-lg">
							...
							<div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
								<ul id="nav" class="navbar-nav ml-auto">
									...
									<li class="nav-item"><a  href="Student_Register.jsp">Student Register</a></li>
									<li class="nav-item"><a  href="Student_Login.jsp">Student Login</a></li>
									<li class="nav-item"><a  href="Teacher_Register.jsp">Teacher Register</a></li>
									<li class="nav-item"><a  href="Teacher_Login.jsp">Teacher Login</a></li>
            ...
            <div class="col-lg-12">
                <div class="row"style="align-items: center;justify-content: center;">
                    <div class="card"style="width: 30rem;align-items: center;color: black;margin-top: 50px;margin-bottom: 50px;">
                        <h5 class="card-title"style="margin-top: 10px;">Teacher Login</h5>
              <script>
                                    ...
                                    <form action="Teacher_Login" method="post" >      
                                        <div class="formbold-mb-3">
                                            <div>
                                                ...
                                                <input type="text"  name="mail_id" id="email" placeholder="Enter your Email" class="formbold-form-input" required />
                                            </div><br>
                                        ...
                                        <div>
                                            <a href="Forgot_Password1.jsp">Forgot Password?</a>
                                        </div>
