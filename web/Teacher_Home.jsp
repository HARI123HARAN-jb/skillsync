 ...
 <% String msg = (String) session.getAttribute("msg");
  ...
  <div class="container-xl">
    <div class="sec-center mb-5">
      ...
      <p class="sec-body">Browse all courses available on the platform. Complete lessons and test knowledge with quizzes.</p>
    </div>
        ...
        <div class="course-card">
          ...
          <div class="course-body">
            ...
            <div class="course-footer">
              ...
              <a href="View_Course.jsp" class="btn-enroll">Manage</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="text-center">
      <a href="View_Course.jsp" class="btn-hero-primary d-inline-flex">
        <i class="bi bi-grid"></i> View All My Courses
      </a>
    </div>
  </div>
</section>
