...
<!-- Mobile Drawer -->
<div class="sk-drawer" id="skDrawer">
  <div class="drawer-body">
    <a href="Admin_Home.jsp" class="drawer-link active" onclick="closeDrawer()">
      <div class="di"><i class="bi bi-house"></i></div> Home
    </a>
    <div class="drawer-section">Approval</div>
    <a href="Student_Approve.jsp"  class="drawer-link" onclick="closeDrawer()"><div class="di"><i class="bi bi-person-check"></i></div> Student Approval</a>
    <a href="Teacher_Approve.jsp"  class="drawer-link" onclick="closeDrawer()"><div class="di"><i class="bi bi-person-workspace"></i></div> Teacher Approval</a>
    <a href="Admin_Course.jsp"     class="drawer-link" onclick="closeDrawer()"><div class="di"><i class="bi bi-journal-check"></i></div> Course Approval</a>
    <div class="drawer-section">View</div>
    <a href="Course_Status.jsp"    class="drawer-link" onclick="closeDrawer()"><div class="di"><i class="bi bi-graph-up"></i></div> Student Course Status</a>
    <a href="Teacher_Detail.jsp"   class="drawer-link" onclick="closeDrawer()"><div class="di"><i class="bi bi-people"></i></div> Teacher Course Detail</a>
    <div class="drawer-divider"></div>
    <a href="index.jsp" class="drawer-link drawer-logout"><div class="di"><i class="bi bi-box-arrow-right"></i></div> Logout</a>
  </div>
</div>
...
<section id="courses" class="section alt">
  <div class="container-xl">
    <div class="sec-center mb-5">
      <div class="sec-eyebrow">Platform Courses</div>
      <h2 class="sec-title">Available Courses</h2>
      <p class="sec-body">Browse the learning modules available on the platform. Students complete lessons and test knowledge with quizzes.</p>
    </div>
    <div class="row g-4 mb-5">
      <div class="col-lg-4 col-md-6 fade-up">
        <div class="course-card">
          <div class="c-thumb">
            <img src="assets/images/image3.jpg" alt="Python">
            <div class="c-overlay"></div>
            <span class="c-badge badge-pop">Popular</span>
          </div>
          <div class="c-body">
            ...
            <div class="c-footer">
              <span class="c-info"><i class="bi bi-clock me-1"></i>Self-paced</span>
              <a href="Admin_Course.jsp" class="btn-view">Manage</a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 fade-up">
        <div class="course-card">
          <div class="c-thumb">
            <img src="assets/images/image2.jpg" alt="Web Dev">
            <div class="c-overlay"></div>
            <span class="c-badge badge-hot">Trending</span>
          </div>
          <div class="c-body">
      ...
      <div class="col-lg-4 col-md-6 fade-up">
        <div class="course-card">
          <div class="c-thumb">
            <img src="assets/images/image5.jpg" alt="C++">
            <div class="c-overlay"></div>
          </div>
          <div class="c-body">
            <div class="c-cat">Programming</div>
            <h4>C++ Programming</h4>
            <p>Learn the fundamentals of C++ programming, OOP concepts, and problem-solving.</p>
            <div class="c-footer">
              <span class="c-info"><i class="bi bi-clock me-1"></i>Self-paced</span>
              <a href="Admin_Course.jsp" class="btn-view">Manage</a>
            </div>
    ...
    <div class="text-center">
      <a href="Admin_Course.jsp" class="btn-view-all">
        <i class="bi bi-grid-3x2-gap"></i> View All Courses
      </a>
    </div>
  </div>
</section>
